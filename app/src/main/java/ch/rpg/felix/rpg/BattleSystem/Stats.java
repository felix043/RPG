...
public class Stats {
    ...
    public Stats(String name, int level, int max_hp, int max_mp, int current_hp, int current_mp, int atk, int mag, int def, int spr) {
        this.name = name;
        this.level = level;
        this.max_hp = max_hp;
        this.max_mp = max_mp;
    ...
    public void castSlash(Stats enemy) {
